...
module.exports = function(Chart) {
	// Global Chart canvas toolbox object for drawing items to canvas
...
module.exports = function(Chart) {
	//Global Chart toolbox object for utility methods and classes
	var helpers = Chart.helpers = {};
...
module.exports = function(Chart) {
	...
	// Private helper to create a tooltip iteam models
